...
initialize_packages() {
    ...
    local xorg_packages=" xorg-server libx11 xorg-xrandr xorg-xinit xorg-xdpyinfo xrdp freerdp2"
    local tools_packages=" qemu-guest-agent git lshw openssh openvpn protonvpn-cli pavucontrol plocate wget curl rsync nfs-utils cifs-utils btop net-tools tree less hwinfo qt5ct pass pacman-contrib figlet"
    local themes_packages=" lxappearance gtk-engine-murrine gnome-themes-extra arc-gtk-theme papirus-icon-theme-git"
    local shell_packages=" bash-completion lsd alacritty kitty starship shell-color-scripts-git"
    ...
    local essential_packages=" vlc-git zathura zathura-djvu zathura-pdf-mupdf nsxiv libreoffice-fresh obsidian syncthing glow"
    local basic_lightdm_packages=" lightdm-slick-greeter lightdm-settings lightdm-gtk-greeter lightdm"
