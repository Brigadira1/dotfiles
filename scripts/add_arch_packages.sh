...
initialize_packages() {
    ...
    local core_packages=" vifm docx2txt mp3info w3m flameshot rofi picom nitrogen tmux brave-bin nomachine"
    ...
    local essential_packages=" vlc zathura zathura-djvu zathura-pdf-poppler zathura-pdf-mupdf nsxim libreoffice-fresh obsidian syncthing"
