...
initialize_packages() {
    ...
    local tools_packages=" qemu-guest-agent git lshw openssh openvpn protonvpn-cli pavucontrol plocate wget curl rsync nfs-utils cifs-utils btop net-tools tree less hwinfo qt5ct pass"
