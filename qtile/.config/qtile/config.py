...
def init_widgets_defaults():
    return dict(font="Hack Nerd, Hack Nerd Font, Symbols Nerd Font, Hack Nerd Font Mono, Symbols Nerd Font Mono", fontsize=12, padding=2, background=colors[1])
...
def init_widgets_list():
    ...
    widgets_list = [
        widget.GroupBox(
            font="Hack Nerd, Hack Nerd Font, Symbols Nerd Font, Hack Nerd Font Mono, Symbols Nerd Font Mono",
            fontsize=20,
            margin_y=-1,
            margin_x=0,
            padding_y=13,
        ...
        widget.CurrentLayout(
            font="Hack Nerd Font", fontsize=15, foreground=colors[5], background=colors[1]
        ),
        widget.Sep(linewidth=1, padding=10, foreground=colors[2], background=colors[1]),
        widget.WindowName(
            font="Hack Nerd Font",
